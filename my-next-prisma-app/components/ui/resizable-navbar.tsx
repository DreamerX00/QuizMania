      ...
      {items.map((item, idx) => {
        ...
        return (
          <Link
            ...
            onClick={onItemClick}
            className="relative px-4 py-2 text-neutral-600 dark:text-neutral-300 hover:text-neutral-800 dark:hover:text-neutral-100"
          >
            {hovered === idx && (
              <motion.div
                layoutId="hovered"
...
export const NavbarLogo = () => {
  return (
    ...
    >
      ...
      <div>
        <span className="font-bold text-lg">QuizMania</span>
      </div>
    </Link>
  );
};
