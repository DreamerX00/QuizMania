        ...
        <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
          ...
          <div className="flex flex-col justify-between py-4">
            ...
            <div className="flex gap-4 pt-12 md:pt-0">
              <button className="group/button flex h-7 w-7 items-center justify-center rounded-full bg-white/80 dark:bg-neutral-800 border border-slate-200 dark:border-neutral-700">
                <IconArrowLeft className="h-5 w-5 text-slate-700 transition-transform duration-300 group-hover/button:rotate-12 dark:text-neutral-400" />
              </button>
              <button className="group/button flex h-7 w-7 items-center justify-center rounded-full bg-white/80 dark:bg-neutral-800 border border-slate-200 dark:border-neutral-700">
                <IconArrowRight className="h-5 w-5 text-slate-700 transition-transform duration-300 group-hover/button:-rotate-12 dark:text-neutral-400" />
              </button>
            </div>
          </div>
        </div>
      ...
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between py-4">
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="group/button flex h-7 w-7 items-center justify-center rounded-full bg-white/80 dark:bg-neutral-800 border border-slate-200 dark:border-neutral-700"
            >
              <IconArrowLeft className="h-5 w-5 text-slate-700 transition-transform duration-300 group-hover/button:rotate-12 dark:text-neutral-400" />
            </button>
            <button
