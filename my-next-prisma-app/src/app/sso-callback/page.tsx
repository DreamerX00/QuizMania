...
export default function SsoCallback() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-950 to-blue-900 dark:from-black dark:to-gray-900 p-2 sm:p-0">
      <div className="flex flex-col items-center space-y-6 p-8 bg-gray-900/80 rounded-2xl shadow-2xl backdrop-blur-lg">
        <div className="relative w-16 h-16">
          ...
          <div className="absolute inset-2 rounded-full bg-gradient-to-br from-blue-600 to-purple-600 opacity-80 blur-sm animate-pulse" />
