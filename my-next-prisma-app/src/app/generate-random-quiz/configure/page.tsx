...
export default function ConfigureQuizPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Redirect to preview page - keep loading state until navigation completes
      router.push(`/generate-random-quiz/preview/${data.data.slug}`);
      // Don't reset loading here - let the navigation/unmount handle it
    } catch (error) {
      const errorMessage =
  ...
  return (
    <>
      {loading && <PageLoader text="Generating your quiz..." />}
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div className="inline-flex items-center gap-4 text-sm">
                      ...
                      <span>
                        Pass Rate:{" "}
                        {(difficultyConfig.passRate * 100).toFixed(0)}%
                      </span>
                    </div>
                  </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">
                          ...
                          {difficultyConfig ? difficultyConfig.baseXP * 3 : 0}{" "}
                          XP
                        </p>
                      </div>
            ...
            <div className="flex items-center justify-between mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              {step < 5 ? (
                ...
                <button
                  ...
                  disabled={loading}
                  className="px-8 py-3 bg-linear-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg flex items-center gap-2"
                >
                  {loading && <Spinner size="sm" withGlow={false} />}
