...
export function Achievements() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 w-12 h-12 bg-linear-to-br from-purple-400/10 to-blue-400/10 dark:from-purple-400/20 dark:to-blue-400/20 rounded-full blur-2xl animate-float z-0" style={{ animationDelay: '2s' }} />
      <div className="grid grid-cols-3 md:grid-cols-4 gap-3 md:gap-4 z-10 relative">
        {achievements.length === 0 ? (
          ...
          achievements.map((ach: any, i: number) => (
            <motion.div
              key={ach.id}
              className={`flex flex-col items-center p-2 md:p-3 rounded-xl shadow-lg relative transition-all duration-300 ${ach.isLocked ? "bg-gray-200 dark:bg-gray-800/80 blur-[2px]" : "bg-linear-to-br from-yellow-400/20 to-yellow-600/20 dark:from-yellow-400/20 dark:to-yellow-600/30 border border-yellow-400/20 animate-glow"}`}
