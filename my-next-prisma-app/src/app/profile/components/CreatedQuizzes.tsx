  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 z-10 relative">
        {quizzes.length === 0 ? (
          <div className="text-gray-500 dark:text-gray-500 col-span-2 text-center py-8">
          ...
          (
            ...
            >
              <div className="font-semibold text-base md:text-lg truncate text-gray-900 dark:text-white">
                {String(quiz.name || "Untitled Quiz")}
              </div>
              <div className="text-gray-600 dark:text-gray-400 text-xs md:text-sm">
                Users Taken:{" "}
                {quiz.usersTaken !== null && quiz.usersTaken !== undefined ? (
                  String(quiz.usersTaken)
                ) : (
              ...
              <div className="text-yellow-600 dark:text-yellow-400 text-xs md:text-sm">
                Rating:{" "}
                {quiz.rating !== null && quiz.rating !== undefined ? (
                  String(quiz.rating)
                ) : (
                  <span className="text-gray-500 dark:text-gray-500">
                    Not rated
              ...
              <div className="flex gap-2 mt-2 flex-wrap">
                ...
                <button
                  className="px-3 py-1 rounded-full bg-red-600/80 text-white hover:bg-red-700 transition text-xs font-semibold"
                  tabIndex={-1}
                >
                  Delete
                </button>
                <button
                  className="px-3 py-1 rounded-full bg-green-600/80 text-white hover:bg-green-700 transition text-xs font-semibold"
                  tabIndex={-1}
                >
                  Promote
                </button>
