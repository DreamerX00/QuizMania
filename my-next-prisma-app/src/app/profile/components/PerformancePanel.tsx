    ...
    >
      ...
      <div className="flex-1 z-10 min-w-0">
        <div className="flex gap-4 md:gap-8 flex-wrap">
          ...
          <div className="flex flex-col items-center min-w-[60px]">
            <span className="text-2xl font-bold text-pink-600 dark:text-pink-400 drop-shadow-glow">
              {stats.streak ?? (
                <span className="text-gray-500 dark:text-gray-500">--</span>
              )}
            </span>
          ...
          <div className="flex flex-col items-center min-w-[60px]">
            <span className="text-2xl font-bold text-yellow-600 dark:text-yellow-400 drop-shadow-glow">
              {stats.timeSpent ? (
                `${stats.timeSpent}h`
              ) : (
                <span className="text-gray-500 dark:text-gray-500">--</span>
