...
export function LiveQuizMap() {
  ...
  return (
    ...
    >
      ...
      <div className="text-xs text-blue-600 dark:text-blue-200/80 mt-2 z-10 relative text-center">
        Real-time map of quizzes active around the world will appear here.
      </div>
    </motion.div>
  );
}
