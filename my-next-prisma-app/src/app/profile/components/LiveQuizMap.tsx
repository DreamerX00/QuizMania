...
export function LiveQuizMap() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 right-0 w-12 h-12 bg-linear-to-br from-blue-400/10 to-pink-400/10 dark:from-blue-400/20 dark:to-pink-400/20 rounded-full blur-2xl animate-float z-0" style={{ animationDelay: '2s' }} />
      <div className="w-full h-40 md:h-48 bg-blue-100 dark:bg-linear-to-br dark:from-blue-800/80 dark:to-blue-600/80 rounded-xl flex items-center justify-center text-blue-700 dark:text-blue-200 text-lg border border-blue-300 dark:border-blue-400/10 shadow-inner z-10 relative">
