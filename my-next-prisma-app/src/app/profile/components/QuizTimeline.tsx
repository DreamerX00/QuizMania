          ...
          quizzes.map((quiz: any, i: number) => (
            ...
            >
              <div className="flex-1 min-w-0">
                <div className="font-semibold text-base md:text-lg truncate">{quiz.title || 'Untitled Quiz'}</div>
                <div className="text-gray-400 text-xs md:text-sm">Score: {quiz.score ?? <span className='text-gray-500'>Not calculated</span>}</div>
