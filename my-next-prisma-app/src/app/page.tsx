...
const Card3DEffect = dynamic(
  () =>
    import("../../components/ui/3d-card-effect").then((mod) => ({
      default: mod.Card3DEffect,
    })),
  {
    ssr: false,
    loading: () => (
...
const GlowingEffect = dynamic(
  () =>
    import("../../components/ui/glowing-effect").then((mod) => ({
      default: mod.GlowingEffect,
    })),
  {
    ssr: false,
  }
...
const SparklesComponent = dynamic(
  () =>
...
const CountUp = dynamic(
  () => import("@/reactBitBlocks/TextAnimations/CountUp/CountUp"),
  {
    ssr: false,
  }
);
...
const TextEffect = dynamic(
  () =>
    import("../../components/motion-primitives/text-effect").then((mod) => ({
...
export default function HomePage() {
  ...
  const testimonials = [
    ...
    {
      quote:
        "Yaar, pehle padhai boring lagti thi, ab toh maza aa gaya! Leaderboard pe naam aane ka alag hi feel hai.",
      name: "Priya Singh",
    ...
    {
      quote:
        "The best part is ki quizzes har subject ke liye mil jaate hain. Revision ke liye perfect hai!",
      name: "Rohan Verma",
    ...
    {
      quote:
        "I love how easy it is to create my own quizzes and share with friends. Bahut hi user-friendly hai!",
      name: "Sneha Patel",
    ...
    {
      quote:
        "Honestly, QuizMania ne meri preparation next level pe le gayi. Analytics feature is super helpful!",
      name: "Vikram Mehra",
    ...
    {
      quote:
        "The leaderboard keeps me on my toes. Roz check karta hoon ki kaun top pe hai!",
      name: "Siddharth Jain",
    ...
    {
      quote:
        "I use QuizMania to prepare for my interviews. The mock tests are very close to real ones.",
      name: "Neha Pillai",
    ...
    {
      quote:
        "Mujhe sabse zyada pasand hai ki app bilkul free hai aur ads bhi nahi aate!",
    ...
    {
      quote:
        "Bahut hi helpful platform hai, especially jab quick revision karna ho before exams.",
      name: "Tarun Sethi",
  ...
  function TextEffectSpeed() {
    return (
      ...
      >
        Experience the next generation of interactive learning with AI-powered
        quizzes, real-time analytics, and a global community of knowledge
        seekers.
      </TextEffect>
    );
  }
  ...
  return (
    <div className="min-h-screen pt-16">
            ...
            >
              <SparklesComponent className="mb-6">
                <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-cyan-500/10 backdrop-blur-sm border border-cyan-500/20">
                  ...
                  <span className="text-slate-800 dark:text-cyan-100 text-sm font-medium">
              ...
              return (
                ...
                >
                  ...
                  <div className="text-2xl font-bold text-slate-800 dark:text-cyan-100 mb-1">
                    <CountUp to={to} duration={2} separator="," />
                    {suffix}
                  </div>
            ...
            <Spotlight>
              <Link href="/multiplayer-arena">
                ...
                >
                  ...
                  <p className="text-slate-600 dark:text-cyan-200/70 leading-relaxed">
                    Challenge friends and players in real-time quiz battles
                  </p>
                </motion.div>
              </Link>
            </Spotlight>
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-slate-600 dark:text-cyan-100 max-w-2xl mx-auto">
          ...
          <GlowingEffect className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-slate-600 dark:text-cyan-100 mb-8 max-w-2xl mx-auto">
                ...
                future of education with QuizMania
              </p>
