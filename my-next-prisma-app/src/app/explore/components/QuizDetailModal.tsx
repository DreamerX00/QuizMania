...
const sampleQuiz = {
  ...
  description:
    "Test your knowledge of advanced Java concepts including multithreading, generics, streams, and the latest features from modern Java versions. This quiz is designed for experienced developers looking to validate their skills.",
  ...
  comments: [
    {
      id: 1,
      user: { name: "Test User 1", avatar: "/default_avatar.png" },
      rating: 5,
      text: "Excellent quiz! Really challenged my understanding of concurrency.",
    },
    {
      id: 2,
      user: { name: "Test User 2", avatar: "/default_avatar.png" },
      rating: 4,
      text: "Great questions, but one of the options in Q12 seemed a bit ambiguous. Overall, very good.",
    },
    {
      id: 3,
      user: { name: "Test User 3", avatar: "/default_avatar.png" },
      rating: 5,
      text: "This is the best Java quiz I've ever taken. Highly recommended!",
    },
  ],
};
...
export default function QuizDetailModal({
  ...
  const handlePurchase = async () => {
    ...
    try {
      ...
      if (!purchaseRes.ok)
        throw new Error(
          purchaseData.error || "Failed to create purchase order."
        );
      ...
      const options: RazorpayOptions = {
        ...
        handler: async function (response: RazorpayResponse) {
          try {
            ...
            if (verifyRes.ok) {
              toast.success(
                "Quiz purchased successfully! You can now attempt it."
              );
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="md:w-3/5 w-full flex flex-col p-6 md:p-8 overflow-y-auto custom-scrollbar bg-white dark:bg-[#10111a]">
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              {quiz.tags.map((tag) => (
                <span
                  key={tag}
                  className="futuristic-badge bg-blue-50 text-blue-900 dark:bg-white/10 dark:text-white/80 px-3 py-1 text-xs rounded-full"
                >
                  {tag}
                </span>
              ))}
          ...
          {/* Description */}
          <div>
            <h3 className="text-xl font-semibold text-fuchsia-500 dark:text-fuchsia-300 mb-2">
              Description
            </h3>
          ...
          {isPremiumUser && isPaidQuiz && !isUnlocked && (
            <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
              ...
              <p className="text-blue-700 dark:text-blue-300 text-sm mt-1">
                Your first attempt on this quiz is free! After that, you&apos;ll
                have unlimited access during your premium subscription.
              </p>
            </div>
          )}
          ...
          <div>
            <h2 className="text-2xl font-bold flex items-center gap-2 mb-4">
              <FiMessageCircle className="text-blue-500 dark:text-blue-400" />{" "}
              User Feedback
            </h2>
              ...
              {quiz.creator?.avatarUrl ? (
                <div className="relative w-12 h-12 shrink-0">
                  <Image
                    ...
                    fill
                    className="rounded-full border-2 border-fuchsia-400 object-cover"
                    sizes="48px"
                  />
                </div>
              ) : (
