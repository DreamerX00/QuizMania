  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-5 gap-3 flex-1 items-center">
        {players.map((player, index) => (
            player ? (
              ...
              <div key={`empty-${index}`} className="flex flex-col items-center gap-1" onClick={() => setInviteModalOpen(true)}>
      ...
      <motion.div
        ...
        whileTap={{ scale: 0.98 }}
      >
        <Button size="lg" className="w-1/2 mx-auto bg-purple-600 hover:bg-purple-700 text-lg font-bold flex items-center gap-2 rounded-full shadow-lg shadow-purple-600/30">
