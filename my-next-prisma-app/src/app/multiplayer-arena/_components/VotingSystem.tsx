...
const VotingSystem = () => {
    const voteOptions = [
        ...
        { name: 'Essay', icon: <FileText size={28}/>, votes: 0 },
        { name: 'Audio', icon: <Mic size={28}/>, votes: 1 },
    ];
      ...
      <div className="grid grid-cols-4 gap-3">
        {voteOptions.map((option) => (
          ...
          >
            ...
            <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">{option.name}</p>
