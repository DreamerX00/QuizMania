...
export default function QuizInitModal({
  open,
  onAcknowledge,
  creatorInfo,
  rules,
      ...
      {!isSignedIn ? (
        <div className="flex flex-col items-center justify-center min-h-[300px] p-8">
          <p className="mb-4 text-lg font-semibold text-red-600">
            You must be signed in to start this quiz.
          </p>
          <button
          ...
          >
              ...
              <AnimatePresence mode="wait">
                ...
                {tab === "creator" && creatorInfo && (
                  ...
                  >
                    ...
                    <div className="font-bold text-2xl text-fuchsia-700 dark:text-fuchsia-300 drop-shadow">
                      {creatorInfo.name}
                    </div>
                    {creatorInfo.message && (
                      <motion.div
                        ...
                        className="italic text-lg text-center text-gray-800 dark:text-gray-200"
                      >
                        “{creatorInfo.message}”
                      </motion.div>
                    )}
            ...
            <div className="flex items-center gap-2 mt-4 mb-2 px-4 md:px-8">
              ...
              <label
                ...
                className="text-sm md:text-base text-gray-700 dark:text-gray-200 select-none"
              >
                I consent to the collection of device and browser information
                for quiz security and anti-cheat purposes. See our{" "}
                <a
                  href="/privacy-policy"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="underline text-fuchsia-600 hover:text-fuchsia-800"
                >
                  Privacy Policy
                </a>
                .
