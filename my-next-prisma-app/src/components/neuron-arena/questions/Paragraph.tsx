...
const Paragraph = ({ question }) => {
  ...
  return (
    <section role="region" aria-labelledby="question-title" className="flex flex-col gap-4">
      <div id="question-title" className="font-heading text-lg mb-2 flex items-center gap-2">
        {question.question}
      ...
      <div data-color-mode="dark">
        <MDEditor
          ...
          preview="edit"
          textareaProps={{
            placeholder: 'Write your detailed answer here... (Markdown supported)',
