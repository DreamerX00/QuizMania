      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-md mx-4 bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl shadow-2xl border border-red-500/20"
          ...
          >
            ...
            <div className="px-6 pb-4">
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/10 mb-4">
                {player.avatar ? (
                  ...
                  <div className="w-14 h-14 rounded-full bg-linear-to-br from-red-500 to-orange-500 flex items-center justify-center text-white font-bold text-xl ring-2 ring-red-500/50">
            ...
            <div className="p-6 pt-2 flex gap-3">
              ...
              <button
                onClick={onConfirm}
                disabled={isLoading}
                className="flex-1 px-4 py-3 rounded-xl bg-linear-to-r from-red-500 to-red-600 text-white font-semibold hover:from-red-600 hover:to-red-700 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
              >
                {isLoading ? (
                  <>
